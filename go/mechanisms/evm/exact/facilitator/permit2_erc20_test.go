...
func TestValidateErc20ApprovalForPayment(t *testing.T) {
	...
	t.Run("invalid format - bad from address", func(t *testing.T) {
		...
		result := ValidateErc20ApprovalForPayment(info, payer, tokenAddress)
		if result != ErrErc20ApprovalInvalidFormat {
			t.Errorf("expected %s, got: %s", ErrErc20ApprovalInvalidFormat, result)
		}
	})
	...
	t.Run("from mismatch", func(t *testing.T) {
		...
		result := ValidateErc20ApprovalForPayment(info, payer, tokenAddress)
		if result != ErrErc20ApprovalFromMismatch {
			t.Errorf("expected %s, got: %s", ErrErc20ApprovalFromMismatch, result)
		}
	})
	...
	t.Run("asset mismatch", func(t *testing.T) {
		...
		result := ValidateErc20ApprovalForPayment(info, payer, tokenAddress)
		if result != ErrErc20ApprovalAssetMismatch {
			t.Errorf("expected %s, got: %s", ErrErc20ApprovalAssetMismatch, result)
		}
	})
	...
	t.Run("wrong spender in info (not Permit2)", func(t *testing.T) {
		...
		result := ValidateErc20ApprovalForPayment(info, payer, tokenAddress)
		if result != ErrErc20ApprovalWrongSpender {
			t.Errorf("expected %s, got: %s", ErrErc20ApprovalWrongSpender, result)
		}
	})

	t.Run("tx parse failed - not valid RLP", func(t *testing.T) {
		// Valid hex (passes format check) but not valid RLP-encoded transaction
		info := &erc20approvalgassponsor.Info{
			From:              payer,
			Asset:             tokenAddress,
			Spender:           evm.PERMIT2Address,
		...
		result := ValidateErc20ApprovalForPayment(info, payer, tokenAddress)
		if result != ErrErc20ApprovalTxParseFailed {
			t.Errorf("expected %s, got: %s", ErrErc20ApprovalTxParseFailed, result)
		}
	})
	...
	t.Run("tx target mismatch", func(t *testing.T) {
		...
		result := ValidateErc20ApprovalForPayment(info, payer, tokenAddress)
		if result != ErrErc20ApprovalWrongTarget {
			t.Errorf("expected %s, got: %s", ErrErc20ApprovalWrongTarget, result)
		}
	})
	...
	t.Run("wrong calldata selector", func(t *testing.T) {
		...
		result := ValidateErc20ApprovalForPayment(info, payer, tokenAddress)
		if result != ErrErc20ApprovalWrongSelector {
			t.Errorf("expected %s, got: %s", ErrErc20ApprovalWrongSelector, result)
		}
	})
	...
	t.Run("wrong calldata spender", func(t *testing.T) {
		...
		result := ValidateErc20ApprovalForPayment(info, payer, tokenAddress)
		if result != ErrErc20ApprovalWrongCalldata {
			t.Errorf("expected %s, got: %s", ErrErc20ApprovalWrongCalldata, result)
		}
	})
	...
	t.Run("signer mismatch - signed by different key", func(t *testing.T) {
		...
		result := ValidateErc20ApprovalForPayment(info, payer, tokenAddress)
		if result != ErrErc20ApprovalSignerMismatch {
			t.Errorf("expected %s, got: %s", ErrErc20ApprovalSignerMismatch, result)
		}
	})
}
